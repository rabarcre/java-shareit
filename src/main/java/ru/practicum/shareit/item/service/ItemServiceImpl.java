...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    @Transactional
    public List<ItemDtoOut> findAll(Integer userId, Integer from, Integer size) {
    ...
    @Override
    @Transactional
    public List<ItemDtoOut> search(Integer userId, String text, Integer from, Integer size) {
        userService.findById(userId);
        Pageable pageable = PageRequest.of(from / size, size);
        if (text.isBlank()) {
